  ...
  module FormsLocations
    ...
    class Engine < ::Rails::Engine
      ...
      initializer "decidim_forms_locations.register_icons" do
        Decidim.icons.register(name: "circle-fill", icon: "circle-fill", category: "system", description: "", engine: :forms_locations)
        Decidim.icons.register(name: "triangle-fill", icon: "triangle-fill", category: "system", description: "", engine: :forms_locations)
        Decidim.icons.register(name: "square-fill", icon: "square-fill", category: "system", description: "", engine: :forms_locations)
        Decidim.icons.register(name: "flag-fill", icon: "flag-fill", category: "system", description: "", engine: :forms_locations)
        Decidim.icons.register(name: "star-fill", icon: "star-fill", category: "system", description: "", engine: :forms_locations)
      end
